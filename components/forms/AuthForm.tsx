...
const AuthForm = (props: Iprops) => {
  ...
  const {
    ...
    if (isLogin) {
      ...
      handleSubmit = () => {
        dispatch(
          AppOperation.login({ email: values.email, password: values.password })
        );
      };
          ...
          <View style={styles.content}>
            <View>
              ...
              <Text style={[styles.text, styles.description]}>
                Создавай свои кулинарные рецепты
              </Text>
            ...
            <Text style={[styles.text, styles.textQuestion]}>
              {questionText}
              <Text
                style={[styles.textQuestion, styles.textQuestionInner]}
